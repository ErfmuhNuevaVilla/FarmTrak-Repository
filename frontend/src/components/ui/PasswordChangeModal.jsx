          ...
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex flex-col sm:flex-row justify-end gap-2 sm:gap-3 pt-4">
                ...
                <button
                  type="submit"
                  disabled={loading || !oldPassword || !newPassword || !confirmNewPassword || newPassword !== confirmNewPassword || newPassword.length < 6}
                  className="px-4 py-2 rounded-lg text-white transition text-sm sm:text-base order-1 sm:order-2 bg-green-600 hover:bg-green-700 disabled:opacity-50 disabled:cursor-not-allowed"
                >
